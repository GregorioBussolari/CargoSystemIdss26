		...
		return { //this:ActionBasciFsm
				...
				state("running") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t028",targetState="handleButtonPressed",cond=whenDispatch("buttonPressed"))
				}	 
				state("handleButtonPressed") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t029",targetState="handleEngaged",cond=whenReply("loadEngaged"))
					transition(edgeName="t030",targetState="handleReject",cond=whenReply("loadRejected"))
					transition(edgeName="t031",targetState="handleRetry",cond=whenReply("retryLater"))
				}	 
